...
public class TalkSearchAbilityServiceGoogleImpl
    ...
    public static final List<String> STANDARD_RESULT_TYPES =
            Arrays.asList("news_results", "organic_results", "related_questions");

    public static final String KNOWLEDGE_CARD_SNIPPET = "Description: %s\n" + "Details:\n" + "%s";

    public static final Set<String> KNOWLEDGE_GRAPH_IGNORE_FIELDS =
            new HashSet<>(
                    Arrays.asList(
                            "title",
                            "description",
    ...
    public static final List<String> LINK_CANDIDATES =
            Arrays.asList(
                    "knowledge_graph_search_link",
                    "serpapi_knowledge_graph_search_link",
                    "website");
    ...
    private SearchContext parseKnowledgeGraph(Map<String, Object> knowledgeGraph) {
        ...
        String snippet = String.format(KNOWLEDGE_CARD_SNIPPET, description, detailsStr).trim();
