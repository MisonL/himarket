...
class PortalFrontendUrlResolverTest {
    ...
    @Test
    void buildCallbackUrlShouldUsePortalFrontendRedirectUrl() {
        ...
        PortalFrontendUrlResolver resolver =
                new PortalFrontendUrlResolver(portalService, contextHolder);

        assertEquals(
                "https://portal.example.com/oidc/callback",
                resolver.buildCallbackUrl("/oidc/callback"));
    }

    @Test
    void buildCallbackUrlShouldRejectMissingFrontendRedirectUrl() {
        PortalResult portalResult = new PortalResult();
        portalResult.setPortalSettingConfig(new PortalSettingConfig());
        ...
        assertThrows(BusinessException.class, () -> resolver.buildCallbackUrl("/cas/callback"));
    }
}
