    ...
    return (
      <Layout>
        <div className="p-8">
          <Alert
            message="错误"
            description={error || "未找到对应的Agent API"}
            type="error"
            showIcon
          />
        </div>
                  ...
                  children: agentConfig?.agentAPIConfig ? (
                    <div className="space-y-6">
                      ...
                      {agentConfig.agentAPIConfig.agentProtocols &&
                        agentConfig.agentAPIConfig.agentProtocols.length >
                          0 && (
                      ...
                      {agentConfig.agentAPIConfig.agentProtocols?.includes(
                        "a2a"
                      ) &&
                          ...
                          <div>
                            ...
                            <div className="border border-gray-200 rounded-xl overflow-hidden bg-white">
                              <Collapse ghost expandIconPosition="end">
                                {agentConfig.agentAPIConfig.routes.map(
                                  (route, index) => (
                                    <Panel
                                      key={index}
                                      header={
                                    ...
                                    >
                                      <div className="px-4 pb-4 space-y-4">
                                            ...
                                            {route.domains?.map(
                                              (domain, domainIndex: number) => {
                                                ...
                                                return (
                                                  <div
                                                    key={domainIndex}
                                                    className="text-sm font-mono text-gray-700 bg-gray-50 px-3 py-2 rounded-lg"
                                                  >
                                        ...
                                        {/* 查询参数匹配 */}
                                        {route.match?.queryParams &&
                                          route.match.queryParams.length >
                                            0 && (
                                            <div>
                                              <div className="text-xs text-gray-500 mb-2">
                                                查询参数匹配:
        ...
        <div className="w-80">
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-white/40 p-6">
            ...
            <div className="text-center py-12">
              ...
              <div className="text-gray-500 mb-2 text-sm">Agent调试功能</div>
