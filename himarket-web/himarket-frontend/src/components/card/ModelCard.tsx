  ...
  return (
    <CommonCard to="/models">
      <div
        className="h-full"
        style={{
          backgroundImage: `url(${HomeModelCardBg})`,
      ...
      >
        <div
          ...
          style={{
            background:
              "linear-gradient(306deg, #0D53FF 1%, rgba(80, 98, 244, 0.7) 59%, rgba(99, 102, 241, 0.09) 98%)",
            opacity: 0.4,
        ...
        <div className="h-full relative z-[3] flex flex-col justify-between p-6">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex pl-3">
              {[Qwen, DeepSeek, ChatGPT, Empty, More].map((img, index) => (
                <img
                  key={index}
                  style={{
                    marginLeft: -12,
