  ...
  return (
    <CommonCard to="/agents">
      <div
        ...
        style={{
          background:
            "linear-gradient(324deg, #C6C8FF 0%, #E1E2FF 21%, #FFFFFF 99%)",
        }}
      />
      <div className="h-full relative z-[3] flex flex-col justify-between p-6">
        <div className="h-full relative flex flex-col gap-4">
          ...
          <div className="flex pl-3">
            {[Person1, Person2, Person3, Person4, More].map((img, index) => (
              <img
                key={index}
                style={{
                  marginLeft: -12,
          ...
          <div className="flex flex-col gap-8 mt-[20%]">
            <div className="flex justify-end">
              <TextTooltip
                className="flex-1 max-w-[90%] animate-[fadeInRight_0.7s_ease-out_0.65s_both] group-hover:translate-x-2 group-hover:scale-105 transition-all duration-300"
                style={{
                  boxShadow: "0px 4px 8px 0px rgba(24, 101, 255, 0.16)",
                }}
                placement="r"
                classNames={{ root: "bg-colorPrimaryBorderHover" }}
              >
            ...
            <div className="flex justify-start">
              <TextTooltip
                className="flex-1 max-w-[90%] animate-[fadeInLeft_0.7s_ease-out_0.8s_both] group-hover:-translate-x-2 group-hover:scale-105 transition-all duration-300"
                style={{
                  boxShadow: "0px 8px 24px 0px rgba(71, 71, 235, 0.08)",
                }}
                placement="l"
                classNames={{ root: "bg-[#F9FAFB]" }}
              >
                <div className="flex flex-col gap-2 w-full p-2">
                  ...
                  <div
                    className="w-full h-2 rounded group-hover:w-3/4 transition-all duration-300"
                    style={{
                      background:
                        "linear-gradient(90deg, rgba(224, 231, 255, 0.7) 0%, rgba(224, 231, 255, 0.2) 100%)",
                    }}
                  ></div>
                  <div
                    className="w-full h-2 rounded group-hover:w-2/3 transition-all duration-300 delay-75"
                    style={{
                      background:
                        "linear-gradient(90deg, rgba(224, 231, 255, 0.7) 0%, rgba(224, 231, 255, 0.2) 100%)",
                    }}
...
function TextTooltip({
  ...
  return (
    <div
      style={style}
      className={`flex items-center relative rounded-lg p-2  ${classNames.root} ${className}`}
    >
      {children}
      <div
        className={`
