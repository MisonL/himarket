...
export function PortalDevelopers({ portal }: PortalDevelopersProps) {
  ...
  const fetchConsumers = (developerId: string, page: number, size: number) => {
    portalApi
      .getConsumerList(portal.portalId, developerId, { page: page, size })
      .then(res => {
        ...
        <Space size="middle">
          ...
          {!portal.portalSettingConfig.autoApproveDevelopers &&
            (record.status === "APPROVED" ? (
              <Button
                onClick={() =>
                  handleUpdateDeveloperStatus(record.developerId, "PENDING")
                }
                type="link"
                icon={<EditOutlined />}
              >
              ...
              <Button
                onClick={() =>
                  handleUpdateDeveloperStatus(record.developerId, "APPROVED")
                }
                type="link"
                icon={<EditOutlined />}
              >
          ...
          <Button
            onClick={() =>
              handleDeleteDeveloper(record.developerId, record.username)
            }
            type="link"
            danger
            icon={<DeleteOutlined />}
