import { Button, Card, Col, DatePicker, Form, Row, Select, type FormInstance } from "antd";
        ...
        <Row gutter={16}>
          <Col span={8}>
            <Form.Item name="cluster_id" label="实例ID">
              <Select mode="tags" placeholder="请选择" style={{ width: "100%" }} options={toTagOptions(filterOptions.clusterIds)} />
            </Form.Item>
          </Col>
          <Col span={8}>
            <Form.Item name="api" label="API">
              <Select mode="tags" placeholder="请选择" style={{ width: "100%" }} options={toTagOptions(filterOptions.apis)} />
            </Form.Item>
          </Col>
          <Col span={8}>
            <Form.Item name="model" label="模型">
              <Select mode="tags" placeholder="请选择" style={{ width: "100%" }} options={toTagOptions(filterOptions.models)} />
            </Form.Item>
          </Col>
        </Row>
        ...
        <Row gutter={16}>
          <Col span={8}>
            <Form.Item name="consumer" label="消费者">
              <Select mode="tags" placeholder="请选择" style={{ width: "100%" }} options={toTagOptions(filterOptions.consumers)} />
            </Form.Item>
          </Col>
          <Col span={8}>
            <Form.Item name="route" label="路由">
              <Select mode="tags" placeholder="请选择" style={{ width: "100%" }} options={toTagOptions(filterOptions.routes)} />
            </Form.Item>
          </Col>
          <Col span={8}>
            <Form.Item name="service" label="服务">
              <Select mode="tags" placeholder="请选择" style={{ width: "100%" }} options={toTagOptions(filterOptions.services)} />
            </Form.Item>
          </Col>
        </Row>
