...
export const GATEWAY_TYPE_OPTIONS = [
  ...
  { label: GATEWAY_TYPE_LABELS.APSARA_GATEWAY, value: "APSARA_GATEWAY" },
] as const;

// 获取Gateway类型中文标签的工具函数
export const getGatewayTypeLabel = (
  type: keyof typeof GATEWAY_TYPE_LABELS
): string => {
